"""
HF Trainer Inference — Decoder-Only with Multi-Head Latent Attention (MLA)

Original: TrainerScripts/DecoderOnlyMLAInference.py
"""
...
CHECKPOINT_DIR = os.path.join(PROJECT_ROOT, "checkpoints", "HF_MLACheckpoints")
MAX_LENGTH = 64
...
def load_model(checkpoint_dir=CHECKPOINT_DIR):
    ...
    base_model = DecoderOnlyMLAModel(
        ...
        num_layers=4, num_heads=4, d_compress=64, d_ff=512, tokenizer=tokenizer,
