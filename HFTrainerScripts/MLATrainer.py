"""
HF Trainer — Decoder-Only with Multi-Head Latent Attention (MLA)

Original: TrainerScripts/DecoderOnlyMLATrainer.py
"""
...
MAX_LENGTH = 64
OUTPUT_DIR = os.path.join(PROJECT_ROOT, "checkpoints", "HF_MLACheckpoints")
