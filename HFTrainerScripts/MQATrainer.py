"""
HF Trainer — Decoder-Only with Multi-Query Attention (MQA)

Original: TrainerScripts/DecoderOnlyMQATrainer.py
"""
...
MAX_LENGTH = 64
OUTPUT_DIR = os.path.join(PROJECT_ROOT, "checkpoints", "HF_MQACheckpoints")
...
if __name__ == "__main__":
    ...
    base_model = DecoderOnlyMQAModel(
    ...
    print("\n" + "=" * 50)
    print("Starting Training — DecoderOnly (MQA)")
    print("=" * 50 + "\n")
