"""
HF Trainer — Decoder-Only (MHA) on versatile_dataset_2000.csv

Full training of the custom DecoderOnlyModel using HuggingFace Trainer.

Original: TrainerScripts/DecoderOnlyTrainer.py
"""
...
# ==================== Configuration ====================
MAX_LENGTH = 64
OUTPUT_DIR = os.path.join(PROJECT_ROOT, "checkpoints", "HF_DecoderOnlyCheckpoints")
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 50)
    print("Starting Training — DecoderOnly (MHA)")
    print("=" * 50 + "\n")
