"""
HF Trainer Inference — Decoder-Only with Group-Query Attention (GQA)

Original: TrainerScripts/DecoderOnlyGQAInference.py
"""
...
CHECKPOINT_DIR = os.path.join(PROJECT_ROOT, "checkpoints", "HF_GQACheckpoints")
MAX_LENGTH = 64
