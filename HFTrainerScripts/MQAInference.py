"""
HF Trainer Inference — Decoder-Only with Multi-Query Attention (MQA)

Original: TrainerScripts/DecoderOnlyMQAInference.py
"""
...
CHECKPOINT_DIR = os.path.join(PROJECT_ROOT, "checkpoints", "HF_MQACheckpoints")
MAX_LENGTH = 64
